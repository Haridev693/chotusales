...
public class LineItem {
	 ...
	 */
	public LineItem(Product product, int quantity, double tax) {
		this(UNDEFINED, product, quantity, tax, product.getUnitPrice());
	}
	 ...
	 */
	public LineItem(int id, Product product, int quantity, double tax,
	...
	public double getTotalTaxAtSale() {
		return (tax) * quantity;
	}
	...
	/**
	 * Sets taxAmount product of this LineItem.
	 * @param taxAmount product of this LineItem.
	 */
	...
	/**
	 * Returns tax product of this LineItem.
	 * @return tax product of this LineItem.
	 */
