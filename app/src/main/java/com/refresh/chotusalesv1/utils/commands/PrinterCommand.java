package com.refresh.chotusalesv1.utils.commands;
...
public class PrinterCommand {
   ...
   public static byte[] POS_Set_PrtInit(){
   	...
   	byte[] data = Command.ESC_Init;//byteArraysToBytes(new byte[][] {Command.ESC_Init});
 		
 		return data;
   }

//	private static byte[] byteArraysToBytes(byte[][] bytes) {
////		byte[] b = new byte[];
////		return b;
//	}
//
   ...
   public static byte[] POS_Set_Cut(int cut){
   	...
   	byte[] data = Other.byteArraysToBytes(new byte[][]{//Other.byteArraysToBytes(new byte[][]{
   			Command.GS_V_m_n
   	});
   	return data;
   }

//	private static byte[] byteArraytoBytes(byte[][] bytes) {
//
//	}
