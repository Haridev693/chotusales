package com.refresh.chotusalesv1.techicalservices.inventory;
...
public class InventoryDaoAndroid implements InventoryDao {
	 ...
	 * @param Context c for use in InventoryDaoAndroid.
	 */
	public InventoryDaoAndroid(Context c) {
	...
	public int addProduct(Product product) {
		...
		content.put("taxid",product.getTaxid());
