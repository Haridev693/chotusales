...
import com.refresh.chotusalesv1.ui.mainui.SettingsActivity;
...
//import sriharidevsoftsols.chotusales.activites.SettingsActivity;
...
public class BluetoothService {
    ...
    private static String NAME = "BlueTooth Printer";
    //UUID must be this
    ...
    public synchronized void start(String PrinterName) {
            ...
            try {
                ...
                mmSocket = (BluetoothSocket) mmDevice.getClass().getMethod("createRfcommSocket", new Class[]{int.class}).invoke(mmDevice, 1);
                    ...
                    try {
                        ...
                        Log.e(TAG, "unable to close() socket during connection failure", e32);
                    }
                }
