...
public class DriveDbHandler extends AppCompatActivity {
    ...
    private static final String FILE_NAME = "com.refresh.chotusalesv1";
    private static final String MIME_TYPE = "application/x-sqlite-3";

    private DriveDbHandler() {
        DATABASE_PATH = getApplicationContext().getDatabasePath("com.refresh.chotusalesv1").getAbsolutePath();
    }



    public void tryCreatingDbOnDrive(final GoogleApiClient googleApiClient) {
    ...
    private  void saveToDrive(final GoogleApiClient googleApiClient) {
    ...
    private void createNewFile(GoogleApiClient googleApiClient, DriveContents driveContents) {
